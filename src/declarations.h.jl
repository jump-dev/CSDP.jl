...
function dnrm2_()
    ccall((:dnrm2_,CSDP.csdp),Cdouble,())
end

function dasum_()
    ccall((:dasum_,CSDP.csdp),Cdouble,())
end

function ddot_()
    ccall((:ddot_,CSDP.csdp),Cdouble,())
end

function idamax_()
    ccall((:idamax_,CSDP.csdp),Cint,())
end

function dgemm_()
    ccall((:dgemm_,CSDP.csdp),Void,())
end

function dgemv_()
    ccall((:dgemv_,CSDP.csdp),Void,())
end

function dger_()
    ccall((:dger_,CSDP.csdp),Void,())
end

function dtrsm_()
    ccall((:dtrsm_,CSDP.csdp),Void,())
end

function dtrmv_()
    ccall((:dtrmv_,CSDP.csdp),Void,())
end

function dpotrf_()
    ccall((:dpotrf_,CSDP.csdp),Void,())
end

function dpotrs_()
    ccall((:dpotrs_,CSDP.csdp),Void,())
end

function dpotri_()
    ccall((:dpotri_,CSDP.csdp),Void,())
end

function dtrtri_()
    ccall((:dtrtri_,CSDP.csdp),Void,())
end
